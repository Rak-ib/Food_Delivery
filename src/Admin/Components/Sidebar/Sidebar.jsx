...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    return (
        <>
            ...
            />
            <div
                className={`pt-10 fixed inset-y-0 left-0 bg-white text-black w-64 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full pointer-events-none'
                    }`}
            >
                <div className="p-4">
                    ...
                    <div className="flex items-center mt-5 space-x-2 p-2 hover:bg-gray-200 cursor-pointer border-b-2 border-gray-400">
                        ...
                        <span><Link to='/admin/add_food'>Add food</Link> </span>
                    </div>
                    <div className="flex items-center mt-5 space-x-2 p-2 hover:bg-gray-200 cursor-pointer border-b-2 border-gray-400">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" /></svg>
                        <span><Link to='/admin/food_list'>Food List</Link> </span>
                    </div>
                    <div className="flex items-center mt-5 space-x-2 p-2 hover:bg-gray-200 cursor-pointer border-b-2 border-gray-400">
