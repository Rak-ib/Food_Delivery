...
const Navbar = () => {
  ...
  const userMenu = <div className="dropdown dropdown-end">
    ...
    <ul
      ...
      <li><Link to="/userOrder">Settings</Link></li>
  ...
  return (
    ...
    <div className="navbar bg-base-100">
      ...
      <div className="navbar-end lg:gap-4 ">
        ...
        {currentUser != null ? userMenu :
          <Link to="/login" className="shadow-sm  border-2 rounded-full hover:bg-orange-500 border-orange-500 w-20 h-11 py-2 px-2">
            SignIn
          </Link>
        }
      </div>
